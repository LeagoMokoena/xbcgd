...
{
    public class daysStory : FlowBase
    {
        ...
        public daysStory(List<Parsed.Object> toplevelObjects, bool isInclude = false) : base(null, toplevelObjects, isIncludedStory: isInclude)
        {
        ...
        public Runtime.daysStory ExportRuntime(ErrorHandler errorHandler = null)
        {
